...
@Component({
  selector: 'app-apactivation',
  templateUrl: './apactivation.component.html',
  styleUrls: ['./apactivation.component.scss']
})
export class APIActivationComponent implements OnInit {
